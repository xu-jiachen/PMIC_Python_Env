...
void pmic_simulink_3d17a902_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 0.001 , 0.001 , 1 , 0 , (
NeModifyAbsTol ) 2 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 ,
618270390 , 0 , 0 , } ; NeSolverParameters solverparams = { 0 , (
...
pmic_simulink_3d17a902_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group ( "pmic_simulink/Solver Configuration_1" , 1 ,
