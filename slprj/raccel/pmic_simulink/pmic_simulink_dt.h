...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . bmq2skyotc [ 0 ] ) , 0 , 0 ,
75 } , { ( char_T * ) ( & rtDW . oojuyjmsnj ) , 0 , 0 , 36 } , { ( char_T * )
( & rtDW . c2jutzvux0 ) , 11 , 0 , 31 } , { ( char_T * ) ( & rtDW .
du34yopqjb [ 0 ] ) , 10 , 0 , 6 } , { ( char_T * ) ( & rtDW . mnf1ndoeql ) ,
8 , 0 , 12 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . Carriercounter_CarrCount ) , 0 , 0 , 80 } } ; static
